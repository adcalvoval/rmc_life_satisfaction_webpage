...
author: "Adrián Calvo Valderrama" # Remember to add your name!
date: "24-07-2024"
theme: united
---
...
table1 <- cantril %>% 
  ...
  rename("Relative Change" = relative_change)
...
ggplotly(line_chart, tooltip = c("Country", "x", "y"))
...
function filter_default() {
  var default_countries = ["Spain", "France", "Finland", "Denmark", "Mongolia", "Iceland", "Uruguay"]; // Set default countries here
